...
def menu(show_select_msg=False):
    with st.sidebar:
        ...
        st.page_link("pages/automatic_filter.py", label="Web Scraper & PDF Manipulation", icon="👷")
        st.page_link("pages/backgroundchecker/momapp.py", label="Web Scraper & PDF Manipulation", icon="👷")
        if show_select_msg:
